...
func _ready():
	...
	SteamLobby.connect("player_joined_lobby", _init_p2p_session)
	SteamLobby.connect("player_left_lobby", _close_p2p_session)
	
	SteamLobby.connect("lobby_created",_init_p2p_host)
	SteamLobby.connect("lobby_owner_changed", _migrate_host)
